...
import type { BookingsConfirmedStaysType } from "../../types/bookingsTypes";
import {
  Cell,
  Legend,
  Pie,
...
interface DurationChartProps {
  confirmedStays: BookingsConfirmedStaysType[] | undefined;
}
...
function DurationChart({ confirmedStays }: DurationChartProps) {
  ...
  return (
    <ChartBox>
      ...
      {data.length <= 0 && <span>There are no stays on these dates</span>}
    </ChartBox>
  );
}
